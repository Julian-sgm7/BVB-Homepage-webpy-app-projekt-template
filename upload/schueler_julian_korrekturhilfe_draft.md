...
- [teilweise] A1: Formales – Syntax, MVC, kein Rechner/Automat, Abgabe (3.00/4.00)
  Evidenz: PHP-CLI nicht verfuegbar, Fehlende MVC-Ordner: controllers, models, views, Kein Rechner/Automat-Code erkannt
  Hinweis: Syntaxcheck nicht ausfuehrbar (php nicht installiert), neutral bewertet. | MVC-Konzept nicht eindeutig umgesetzt (Ordner controllers/models/views fehlen). | Kein dynamischer Teil (Rechner/Automat) gefunden. | Abgabe puenktlich. | Vier Teilprüfungen werden automatisch dokumentiert; Sonderregel zur milden Verspätung ist hinterlegt.
- [erfuellt] B1: Projektstruktur und Quellcode-Qualität (4.00/4.00)
  Evidenz: index.php, css/styles.css, layouts/service.php
...
- [erfuellt] C1: Dynamisches Layout und Inhalt (4.00/4.00)
  Evidenz: controller/RechnerController.php, layouts/service.php, layouts/impressum.php
...
- [teilweise] D1: Bilder und Galerie (0.00/4.00)
  Evidenz: img/BVB_Kissen.png, img/BVB_Logo.png, img/Stadionadresse.png
  Hinweis: 2/3 Teilregeln erfüllt. Nicht erfüllt: Keine Teilregel erfüllt: 1/2 Teilregeln erfüllt. Nicht erfüllt: Nur 0 Datei(en) fuer Syntaxcheck '**/*.js' gefunden, Minimum ist 1.; 1/2 Teilregeln erfüllt. Nicht erfüllt: Regex '(?i)(?:\.preview|\.lightbox|\.modal|\.viewer|\.gallery|:target)' in keiner Datei für Muster '**/*.css' gefunden. | Bildoptimierung (<200 KB je Bild), Bedienbarkeit von Preview/View im Browser und Verlinkung externer Quellen manuell pruefen.
- [teilweise] E1: Verweise – interne und externe Links (0.00/4.00)
  Evidenz: index.php, layouts/service.php, layouts/mannschaften.php
  Hinweis: 1/2 Teilregeln erfüllt. Nicht erfüllt: Regex 'target=["']_blank["']' in keiner Datei für Muster '**/*.php' gefunden. | Qualität und Sinnhaftigkeit der Navigation manuell prüfen.
- [erfuellt] F1: PHP-Eigenanteil und Formulare (4.00/4.00)
  Evidenz: index.php, controller/RechnerController.php, layouts/service.php
...
- [teilweise] I1: Farbgestaltung und Design (0.00/4.00)
  Evidenz: css/styles.css, css/styles.css, css/styles.css
...
- [teilweise] J1: Sonstige Features – Impressum, Datenschutz und KI-Inhalte (0.00/4.00)
  Evidenz: layouts/impressum.php, layouts/impressum.php, layouts/footer.php
